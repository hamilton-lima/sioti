...
/**
 * Started Date: Aug 19, 2004<br>
 * <br>
 * 
 * This program introduces jME's terrain utility classes and how they are used.
 * It goes over ProceduralTextureGenerator, ImageBasedHeightMap,
 * MidPointHeightMap, and TerrainBlock.
 * 
...
public class HelloTerrain extends SimpleGame {
	...
	private void homeGrownHeightMap() {
		...
		int[] map = new int[] { 1, 2, 3, 4, 2, 1, 2, 3, 3, 2, 1, 2, 4, 3, 2, 1 };
		...
		TerrainBlock tb = new TerrainBlock("block", 4, new Vector3f(2, 1, 2),
				map, new Vector3f(0, 0, 0), false);
	...
	private void complexTerrain() {
		...
		URL grayscale = HelloTerrain.class.getClassLoader().getResource(
				"jmetest/data/texture/bubble.jpg");
		// These will be the textures of our terrain.
		URL waterImage = HelloTerrain.class.getClassLoader().getResource(
				"jmetest/data/texture/water.png");
		URL dirtImage = HelloTerrain.class.getClassLoader().getResource(
				"jmetest/data/texture/dirt.jpg");
		URL highest = HelloTerrain.class.getClassLoader().getResource(
